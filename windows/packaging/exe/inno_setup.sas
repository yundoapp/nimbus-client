...
[UninstallDelete]
Type: filesandordirs; Name: "{userappdata}\Yundo"
...
begin
  ...
  Exec('net', 'stop "YundoTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Exec('sc.exe', 'delete "YundoTunnelService"', '', SW_HIDE, ewWaitUntilTerminated, ResultCode)
  Result := True;
end;

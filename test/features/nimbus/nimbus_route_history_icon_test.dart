...
void main() {
  test('route access uses the rocket for acceleration and globe for direct access', () {
    expect(nimbusRouteAccessIcon(requiresConnection: true), Icons.rocket_launch_rounded);
    expect(nimbusRouteAccessIcon(requiresConnection: false), Icons.language_rounded);
  });

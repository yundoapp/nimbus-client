...
import 'package:hiddify/features/nimbus/auth/data/nimbus_device_identity.dart';
...
class NimbusAuthRepository {
  NimbusAuthRepository({
    ...
    NimbusDeviceIdentity? deviceIdentity,
    Dio? dio,
       ...
       _deviceIdentity = deviceIdentity ?? NimbusDeviceIdentity(preferences: preferences),
       _dio =
           dio ??
           Dio(
             BaseOptions(
  ...
  final NimbusDeviceIdentity _deviceIdentity;
  final Dio _dio;
  ...
  String get _deviceId {
    return _deviceIdentity.resolve();
  }
